        ...
        >
          ...
          <div className="relative">
            ...
            <div className="max-h-96 overflow-y-auto px-10 mt-5">
                ...
                <li> So there is no Terms & Conditions available at the moment. </li>
                <li> We are working hard to provide you with the best experience. </li>
                <li> We will update the Terms & Condition as soon as the application is ready. </li>
                ...
                <li> You are not advised to Join / Sign In / Sign Up/ Go to Dashboard on the website for now without <a href="mailto:vacantvectors@gmail.com" className="text-white underline">contacting</a> us.</li>
                <li> By using this website you are agreeing to comply with and be bound by the following above points, which together with our privacy policy & disclaimer govern Vacant Vectors's relationship with you in relation to this website. </li>
