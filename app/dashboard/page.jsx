  ...
  return (
      <div className='bg-black text-white antialiased h-screen flex items-center justify-center'>
          ...
          >
              ...
              <div className="container relative flex flex-col items-center justify-center text-center lg:p-0 md:p-0 p-5">
                  <h1 className="text-7xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text">Dashboard</h1>
                  <p className="text-4xl md:text-3xl font-bold sm:text-lg text-white/100 mt-5 max-w-2xl">Give a Interview to begin the process</p>
                  <div className="mt-5">
                      <AddNewInterview />
                  </div>
                  <p className="text-lg md:text-xl text-white/70 mt-5 max-w-xl">You are allowed to give only one Interview, so make sure you are ready. In case of any issues, please <a href="mailto:vacantvectors@gmail.com" className="text-white underline">contact</a> the support team.</p>
                  <div className="container mt-5 lg:mt-20 md:mt-15">
                    <InterviewList />
                  </div>
              </div>
          </motion.section>
