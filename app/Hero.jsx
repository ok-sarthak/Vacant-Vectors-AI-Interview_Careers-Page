        ...
        <div className='bg-black text-white antialiased h-screen flex items-center justify-center'>
            ...
            >
                ...
                <div className="container relative flex flex-col items-center justify-center text-center">
                    <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text">Vacant Vectors</h1>
                    <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text">Careers</h1>
                    <p className="text-4xl md:text-3xl font-bold sm:text-lg text-white/100 mt-5 max-w-2xl">Infusing the Vacant Universe with AI Vectors</p>
                    <p className="text-lg md:text-xl text-white/70 mt-5 max-w-xl">We are not currently recruiting, but we are always looking for talented individuals to join our team. If you are interested in working with us, then <a href="mailto:vacantvectors@gmail.com" className="text-white underline">send</a> us your resume and we will keep it on file for future opportunities. Stay tuned !!</p>
                    <div className="mt-5">
                        {/* <Button onClick={() => router.replace('/dashboard')}>Join Us</Button> */}
                        <Button onClick={() => alert('We are not currently recruiting.')}>Join Us</Button>
                    </div>
                </div>
            </motion.section>
        </div>
